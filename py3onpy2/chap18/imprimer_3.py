...
cG =Frame(1*cm, 11*cm, 9*cm, 16*cm, showBoundary =1)
cD =Frame(11*cm, 11*cm, 9*cm, 16*cm, showBoundary =1)
cI =Frame(1*cm, 3*cm, 19*cm, 7*cm,  showBoundary =1)
...
cG =Frame(1*cm, 12*cm, 9*cm, 15*cm, showBoundary =1)        # deux cadres
cD =Frame(11*cm, 12*cm, 9*cm, 15*cm, showBoundary =1)       # (= 2 colonnes)
cG.addFromList(story, can)                    # remplir le cadre de gauche
cD.addFromList(story, can)                    # remplir le cadre de droite
