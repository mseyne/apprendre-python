...
# Adaptations du script pour exécution sous Python 3 ou Python 2 :
import sys
if sys.version[0] =='2':       # test de la version de Python utilisée
    from Tkinter import *      # module Tkinter pour Python2
    # Remplacer la fonction open() standard de python2 par celle du module
    # codecs, qui fonctionne comme celle de python3 (c.à.d. avec décodage) :
...
class ScrolledText(Frame):
    ...
    def importFichier(self, fichier, encodage ="Utf8"):
        ...
        # Rem.: les 2 versions de Tkinter utilisent des chaînes unicode
...
st.importFichier("CorbRenardLatin1.txt", encodage ="Latin1")
